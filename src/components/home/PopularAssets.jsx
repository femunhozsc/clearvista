...
import { Globe, Bitcoin, Building, Image as ImageIcon } from 'lucide-react';
...
const AssetCard = ({ title, data, valueKey, unit, icon: Icon }) => (
  <motion.div 
...
const PopularAssets = () => {
  return (
    <div>
      ...
      >
        <AssetCard 
          title="BDRs Populares" 
          data={mockMarketData.popularBDRs} 
          valueKey="price"
          unit=""
          icon={Globe}
        />
        <AssetCard 
          title="Criptomoedas Populares" 
          data={mockMarketData.popularCrypto} 
          valueKey="price"
          unit=""
          icon={Bitcoin}
        />
        <AssetCard 
          title="FIIs Populares" 
          data={mockMarketData.popularFIIs} 
          valueKey="price"
          unit=""
          icon={Building}
        />
